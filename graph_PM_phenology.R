...
pdf(paste("/Users/yzhang/Dropbox/YAOZHANG/paper/2018_SIF_phenology/pheno_map_PM_VI.pdf",sep=""),width=11/3*2.4,height=11)
par(fig=c(0,0.45,2/3,1),mar=c(0.4,0.4,0.4,0.4),mgp=c(3,0.3,0))
plot(border)
image(setrange(aesos/365,0.2192,0.5479),add=T,col=lst_color_ramp,axes=F,zlim=c(0.2192,0.5479))
...
plot(border)
image(setrange(aeeos/365,0.5479,0.8768),add=T,col=rev(lst_color_ramp),axes=F,zlim=c(0.5479,0.8768))
...
plot(border)
image(setrange(aelgs/365,0.2191,0.5480),add=T,col=rev(lst_color_ramp),axes=F,zlim=c(0.2191,0.5480))
...
plot(border)
image(setrange(aesos_t/365,-0.004109589,0.004109589),add=T,col=rev(ano_discrete_ramp),
...
plot(border)
image(setrange(aeeos_t/365,-0.004109589,0.004109589),add=T,col=ano_discrete_ramp,
      axes=F,zlim=c(-0.004109589,0.004109589))
text(0, 5500000,"EOS",cex=1.3)
plotlatlong()
...
plot(border)
image(setrange(aelgs_t/365,-0.00822,0.00822),add=T,col=ano_discrete_ramp,axes=F,zlim=c(-0.00822,0.00822))
text(0, 5500000,"LGS",cex=1.3)
plotlatlong()
