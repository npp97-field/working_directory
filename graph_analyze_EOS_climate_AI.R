...
arrows(x0 = 0.55,x1 = 0.2, y0 = 340,y1=340,length = 0.1)
arrows(x0 = 0.65,x1 = 1, y0 = 340,y1=340,length = 0.1)
text(0.08,340,"dry")
text(1.12,340,"wet")
...
par(new=T)
histneg<-hist(negativeall[,2],breaks=0:36*0.05,plot=F)
plot(NA,xlim=c(0,1.8),ylim=c(0,7),axes=F,space=0,xaxs='i',yaxs="i",xlab="",ylab="")
...
histpos<-hist(positiveall[,2],breaks=0:36*0.05,plot=F)
...
arrows(x0 = 0.55,x1 = 0.2, y0 = 2.794521,y1=2.794521,length = 0.1)
arrows(x0 = 0.65,x1 = 1., y0 = 2.794521,y1=2.794521,length = 0.1)
text(0.08,2.794521,"dry")
text(1.12,2.794521,"wet")
for (i in 1:4){
...
text(0.018,0.4,"hyperarid",xpd = NA)
text(0.125,0.8,"arid")
